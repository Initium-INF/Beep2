...
export default function Home() {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Renderiza os BlockPickers para cada bloco */}
      <BlockPicker
        title="Bloco A"
      ...
      {/* Outros BlockPickers para outros blocos (Bloco B, C, D, E) com funcionalidades similares */}

      {/* Botão para iniciar o escaneamento se uma sala for selecionada */}
      {isRoomSelected && (
        <Button
          title="Começar a Scanear"
          onPress={() => {
            // Adicionar a Lógica de Scaneamento
